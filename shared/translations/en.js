...
export const en = {
    ...
    Settings_NotVerifiedAccountTitle: 'Твой профиль не верифицирован',
    Settings_NotVerifiedAccountMessage: 'Некоторые функции сайта не доступны для таких аккаунтов. Также ваш профиль не будет отображаться в списке пользователей сайта.<br>Для верификации аккаунта необходимо выполнить следующие задания:',
