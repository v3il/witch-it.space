...
export const ru = {
    ...
    Error_WrongDiscordTag: 'Некорректный Discord тег',
    Error_WrongDisplayName: 'Некорректное отображаемое имя',
    Error_WrongSteamAccountURL: 'Некорректная ссылка профиля Steam',
    Error_WrongSteamTradeURL: 'Некорректная ссылка обмена Steam',
    Error_WrongAvatarId: 'Некорректный аватар',
