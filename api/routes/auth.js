...
import { fetchUser } from '../interceptors'

const authRouter = createAsyncRouter()

authRouter.get('/discord', discordAuthController.authUsingDiscord)
authRouter.get('/discord/callback', fetchUser, discordAuthController.authUsingDiscordCallback)

authRouter.get('/google', googleAuthController.authUsingGoogle)
authRouter.get('/google/callback', fetchUser, googleAuthController.authUsingGoogleCallback)

authRouter.get('/steam', steamAuthController.authUsingSteam)
authRouter.get('/steam/callback', fetchUser, steamAuthController.authUsingSteamCallback)
